...
static void BM_CTOR_16_16_UPP(benchmark::State& state) {
    ...
    for (auto _ : state) {
        MatrixBasic<opt::Interval, n1, n1> a(intervals);
...
static void BM_CTOR_16_16_CAPD(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        MatrixBasic<capd::filib::Interval<double>, n1,n1> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_16_16_BATCH_MIX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixMixed<n1, n1> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_16_16_BATCH_GRP(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrix_Grouped<n1, n1> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_16_16_BATCH_GRP_AVX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX_Grouped<n1, n1> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_16_16_BATCH_GRP_AVX512(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX512_Grouped<n1, n1> a(intervals) ;
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_UPP(benchmark::State& state) {
    ...
    l.roundUp();
    for (auto _ : state) {
        MatrixBasic<opt::Interval,n2, n2> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_CAPD(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
       MatrixBasic<capd::filib::Interval<double>,n2, n2> a(intervals); 
       benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_BATCH_MIX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixMixed<n2, n2> a(intervals); 
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_BATCH_GRP(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
       BatchSwitchMatrix_Grouped<n2, n2> a(intervals);
       benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_BATCH_GRP_AVX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX_Grouped<n2, n2> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_104_104_BATCH_GRP_AVX512(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX512_Grouped<n2, n2> a(intervals); 
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_UPP(benchmark::State& state) {
    ...
    l.roundUp();
    for (auto _ : state) {
        MatrixBasic<opt::Interval,n3, n3> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_CAPD(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
       MatrixBasic<capd::filib::Interval<double>,n3, n3> a(intervals); 
       benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_BATCH_MIX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixMixed<n3, n3> a(intervals); 
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_BATCH_GRP(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
       BatchSwitchMatrix_Grouped<n3, n3> a(intervals);
       benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_BATCH_GRP_AVX(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX_Grouped<n3, n3> a(intervals);
        benchmark::DoNotOptimize(a);
    }
}
...
static void BM_CTOR_304_304_BATCH_GRP_AVX512(benchmark::State& state) {
    ...
    auto intervals = generateArray(array_size,42);
    for (auto _ : state) {
        BatchSwitchMatrixAVX512_Grouped<n3, n3> a(intervals); 
        benchmark::DoNotOptimize(a);
    }
}
