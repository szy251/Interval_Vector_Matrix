...
static constexpr double SCALAR_LOW = 2.0;
static constexpr double SCALAR_UPP = 6.0;




static void BM_MLT_SCL_25_AVX(benchmark::State& state) {
    ...
    capd::filib::Interval<double> scalar(SCALAR_LOW, SCALAR_UPP);
    for (auto _ : state) {
        auto result = matrix * scalar;
        benchmark::DoNotOptimize(result);
    }
}
BENCHMARK(BM_MLT_SCL_25_AVX);


static void BM_MLT_SCL_50_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_50_AVX);


static void BM_MLT_SCL_75_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_75_AVX);


static void BM_MLT_SCL_100_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_100_AVX);


static void BM_MLT_SCL_125_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_125_AVX);


static void BM_MLT_SCL_150_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_150_AVX);


static void BM_MLT_SCL_175_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_175_AVX);


static void BM_MLT_SCL_200_AVX(benchmark::State& state) {
...
BENCHMARK(BM_MLT_SCL_200_AVX);




static void BM_MLT_SCL_25_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_25 * N_25;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_25_AVX512);


static void BM_MLT_SCL_50_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_50 * N_50;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_50_AVX512);


static void BM_MLT_SCL_75_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_75 * N_75;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_75_AVX512);


static void BM_MLT_SCL_100_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_100 * N_100;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_100_AVX512);


static void BM_MLT_SCL_125_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_125 * N_125;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_125_AVX512);


static void BM_MLT_SCL_150_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_150 * N_150;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_150_AVX512);


static void BM_MLT_SCL_175_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_175 * N_175;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_175_AVX512);


static void BM_MLT_SCL_200_AVX512(benchmark::State& state) {
    const size_t num_intervals = N_200 * N_200;
    auto intervals_data = generateArray(num_intervals, 42);
...
BENCHMARK(BM_MLT_SCL_200_AVX512);
